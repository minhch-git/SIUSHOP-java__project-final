    ...
    <div class="grid wide grid-cols-12 gap-x-8">
        ...
        <div class="col-span-12">
            <div class="breadcrumd d-flex justify-start align-center">
                ...
                <span class="separate-characters pl-1">/</span>
                <a href="/siuShop_war_exploded/new-product" class="breadcrumd-link active">New</a>
            </div>
        </div>
        <div class="col-span-12 laber-themes mt-3">
            ...
            <div class="grid grid-cols-12 bg-white mt-4 mb-8">
                <div class="mt-4 mb-8 col-start-4 col-end-10">
                    ...
                    <form class="form px-8 py-1" action="/siuShop_war_exploded/new-product" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control flex-1" type="number" name="price" id="price"
                                   placeholder="400000" />
                        </div>

                        <div class="form-group">
                            <label class="form-label" for="promotionPrice"> Giá khuyến mãi</label>
                            <input class="form-control flex-1" type="number" name="promotionPrice" id="promotionPrice"
                                   placeholder="400000" />
                        </div>

                        <div class="form-group">
                            <label class="form-label" for="exclusive">Độc quyền</label>
                            <input class="form-control flex-1" type="number" name="exclusive" id="exclusive"
                                   value="1"/>
                        </div>
                        ...
                        <div class="form-group">
                            <input class="mt-4 form-control bg-success fz-md text-white cursor-pointer" type="submit" value="Đăng sản phẩm" />
                        </div>
                    </form>
                </div>
            </div>
