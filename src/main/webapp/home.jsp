    ...
    <div class="grid wide grid-cols-12 gap-x-8">
        ...
        <div class="col-span-12">
            <div class="breadcrumd d-flex justify-start align-center">
                <a href="/siuShop_war_exploded/home" class="breadcrumd-link active">Trang chủ</a>
                <span class="separate-characters pl-1">/</span>
                <a href="/siuShop_war_exploded/home" class="breadcrumd-link">siuShop Online</a>
            </div>
        </div>
                    ...
                    <li class="sidebar-item">
                        <div class="sidebar-filter">
                            ...
                            <ul class="sidebar-filter__list">
                                <!-- <li class="sidebar-filter__item"><a href="">Số đầu</a></li> -->
                            </ul>
                        </div>
                    </li>
                </ul>
        ...
        <div class="col-span-9">
            <div class="grid grid-cols-3 gap-8">
                <div class="col-span-3">
                    <div class="product-title">siuShop Online</div>
                </div>
                <div class="col-span-3">
                    <div class="grid grid-cols-2">
                        <div class="view d-flex justify-start align-center">
                            <%@include file="/includes/view-button.jsp"%>

                            <div class="view__product-number">
                                <span>Có <span>${products != null ? products.size() : 0}</span> sản phẩm</span>
                            </div>

                        </div>

                        <%@include file="/includes/filter/filter.jsp"%>
                    </div>
                </div>
